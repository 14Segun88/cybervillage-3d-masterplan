...
export class WorldClawEngine {
  ...
  createSteamParticleSystem() {
    ...
    if (cityId === 'kemerovo') {
      ...
      emitters = [
        { x: -248.0, y: 31.0, z: -46.0 }, // Coal TPP Chimney 1 (ровно из жерла трубы)
        { x: -234.0, y: 31.0, z: -46.0 }, // Coal TPP Chimney 2 (ровно из жерла трубы)
        { x: -250.0, y: 30.0, z: 6.0 },   // Gas TPP Chimney 1 (ровно из жерла трубы на новой позиции)
        { x: -227.0, y: 26.0, z: 6.0 }    // Gas TPP Chimney 2 (ровно из жерла трубы на новой позиции)
      ];
    }
  ...
  buildFacilityNameBadges() {
    ...
    if (cityId === 'moscow') {
      ...
      badges = [
        ...
        { title: "Угольная ТЭЦ (2×150 МВт)", sub: "Автономная генерация • Турбинный зал", icon: "⚡", x: -248, y: 32, z: -30, color: "#f59e0b" },
        { title: "Газовая ТЭЦ (Газотурбинная)", sub: "Котлы HRSG • Газовые турбины • 2 трубы", icon: "🔥", x: -248, y: 24, z: 24, color: "#0ea5e9" },
        { title: "СЭС и Накопители BESS", sub: "Солнечный парк • Буферные АКБ", icon: "☀️", x: -155, y: 18, z: -30, color: "#facc15" },
        { title: "Тепличный агрокомплекс (2 ряда / 8 теплиц)", sub: "4 теплицы (овощи) + 4 теплицы (зелень/ягоды)", icon: "🌱", x: -200, y: 16, z: 20, color: "#22c55e" },
        { title: "Фабрика-кухня, Сад и Животноводство", sub: "Собственное сырье, фруктовый сад", icon: "🥩", x: -140, y: 18, z: 25, color: "#f97316" },
