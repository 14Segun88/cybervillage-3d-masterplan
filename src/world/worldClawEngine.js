  ...
  buildFacilityNameBadges() {
    ...
    if (cityId === 'moscow') {
      ...
      badges = [
        ...
        { title: "Тепличный агрокомплекс (Нижний ряд)", sub: "На уровне Газовой ТЭЦ • Ягоды и злаки", icon: "🌱", x: -210, y: 18, z: 28, color: "#22c55e" },
        { title: "Ферма: Луга с овощами и Пастбище животных", sub: "Грядки моркови, капусты, кукурузы • Коровы и овцы", icon: "🥩", x: -130, y: 18, z: 0, color: "#f97316" },
