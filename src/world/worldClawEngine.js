...
export class WorldClawEngine {
  ...
  createSteamParticleSystem() {
    ...
    if (cityId === 'kemerovo') {
      ...
      emitters = [
        { x: -290.0, y: 31.0, z: -46.0 }, // Coal TPP Chimney 1 (ровно из жерла трубы)
        { x: -276.0, y: 31.0, z: -46.0 }, // Coal TPP Chimney 2 (ровно из жерла трубы)
        { x: -292.0, y: 30.0, z: 12.0 },  // Gas TPP Chimney 1 (ровно из жерла трубы на новой позиции)
        { x: -269.0, y: 26.0, z: 12.0 }   // Gas TPP Chimney 2 (ровно из жерла трубы на новой позиции)
      ];
    }
  ...
  buildFacilityNameBadges() {
    ...
    if (cityId === 'moscow') {
      ...
      badges = [
        ...
        { title: "Угольная ТЭЦ (2×150 МВт)", sub: "Автономная генерация • Турбинный зал", icon: "⚡", x: -285, y: 32, z: -28, color: "#f59e0b" },
        { title: "Газовая ТЭЦ (Газотурбинная)", sub: "Котлы HRSG • Газовые турбины • 2 трубы", icon: "🔥", x: -285, y: 26, z: 28, color: "#0ea5e9" },
        { title: "Тепличный агрокомплекс (Верхний ряд)", sub: "На уровне Угольной ТЭЦ • Овощи и зелень", icon: "🌱", x: -210, y: 18, z: -28, color: "#22c55e" },
        { title: "Ферма и Фабрика-кухня", sub: "Агропереработка • Хранилища и силосы", icon: "🥩", x: -128, y: 20, z: 0, color: "#f97316" },
        { title: "Овощные луга и Поля (Морковь, Капуста, Кукуруза)", sub: "Орошаемые грядки и агрокультуры", icon: "🥕", x: -130, y: 16, z: -48, color: "#22c55e" },
        { title: "Пастбище животных и Коровник", sub: "Коровы, овцы, стога сена и трактор с урожаем", icon: "🐄", x: -130, y: 16, z: 34, color: "#facc15" },
